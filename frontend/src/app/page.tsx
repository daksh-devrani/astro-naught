        ...
        >
          ...
          <div className="flex justify-center gap-4">
            {primaryProfile && (
              <Link 
                href="/dashboard" 
                className="px-6 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 hover:bg-indigo-500/20 hover:text-indigo-300 transition-all text-sm font-bold uppercase tracking-widest flex items-center gap-2"
              >
                Go to Dashboard
              </Link>
            )}
            <Link 
              href="/match" 
              className="px-6 py-2 rounded-full bg-pink-500/10 border border-pink-500/30 text-pink-400 hover:bg-pink-500/20 hover:text-pink-300 transition-all text-sm font-bold uppercase tracking-widest flex items-center gap-2 shadow-[0_0_15px_rgba(236,72,153,0.2)]"
            >
              Try Kundli Matching (Synastry)
            </Link>
          </div>
        </motion.div>
